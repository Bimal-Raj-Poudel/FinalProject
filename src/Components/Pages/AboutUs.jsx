        ...
        <div className="row">
          <div className="col-sm-12 position-relative">
            ...
            <div className="sinse-box">
              <h3 className="sinse-title">GharBhada
                <span></span>
                <br/> Since 2023
              </h3>
            ...
            <div className="row">
              ...
              <div className="col-lg-2  d-none d-lg-block position-relative">
                <div className="title-vertical d-flex justify-content-start">
                  <span>GharBhada Exclusive Property</span>
                </div>
              </div>
            ...
            <div className="card-box-d">
              ...
              <div className="card-overlay card-overlay-hover">
                <div className="card-header-d">
                  <div className="card-title-d align-self-center">
                    <h3 className="title-d">
                      <a href="agent-single.html" className="link-two">Bimal Raj 
                        <br/> Poudel </a>
                    </h3>
                  </div>
                </div>
            ...
            <div className="card-box-d">
              ...
              <div className="card-overlay card-overlay-hover">
                <div className="card-header-d">
                  <div className="card-title-d align-self-center">
                    <h3 className="title-d">
                      <a href="agent-single.html" className="link-two">Raju 
                        <br/> Boudel </a>
                    </h3>
                  </div>
                </div>
